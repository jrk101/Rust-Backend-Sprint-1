...
| 3 | `R3.1–R3.4` domain types, errors, traits, tests; `R3.5` extension | — | — | — |
...
| 10 | — | — | `D4.1–D4.2` dead letters and replay | `E7.1–E7.2` operator demonstration |
| 11 | — | `A5.1–A5.2` protected management API and exposure; `A6.1` limits | `D5.1–D5.3` auth and optional Redis | `E8.1–E8.2` threat and secret policy |
