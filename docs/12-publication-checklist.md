...
- [ ] Dates and duration of the 13 units recorded in the cohort announcement
...
- [ ] A minimal shared Cargo workspace exists before the Unit 4 rotation
- [ ] `rust-toolchain.toml`, `Cargo.lock`, `.gitignore`, and `.env.example` exist
- [ ] Shared CI runs on a sample pull request before Unit 4
- [ ] PostgreSQL/SQLx migration commands are tested before Unit 6
...
- [ ] The Unit 10 failure sequence is rehearsed on a disposable database
- [ ] The Unit 13 clean-start test is performed by a non-author
